...
def testDeleteTourMatches():
    tournament = registerTournament("U.S. Open")
    deleteTourMatches(tournament)
    deleteTournaments()
    print "2. Old matches in a tournament can be deleted."
...
def testReportMatches():
    ...
    reportMatch(id1, id2, id1, round, tournament)
    reportMatch(id3, id4, id3, round, tournament)
    standings = playerStandings(tournament)
